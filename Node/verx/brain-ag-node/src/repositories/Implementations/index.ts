...
const postgresFarmRepository:PostgresFarmRepository = new PostgresFarmRepository()

export {postgresFarmerRepository, postgresAddressRepository, postgresFarmRepository}